...
@Component({
  selector: 'app-videoadmin',
  templateUrl: './videoadmin.component.html',
  styleUrls: ['./videoadmin.component.css']
})
export class VideoAdminComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.videoAdminForm = this.formBuilder.group({
  ...
  get f() {
    return this.videoAdminForm.controls;
  }
  onSubmit() {

    this.submitted = true;
    if (this.videoAdminForm.invalid) {
      return;
    }
